...
public class SchoolTest {
    ...
    @Test
    public void whenGreaterStudent() {
        ...
        List<Student> list = school.collect(students, predicate);
    ...
    @Test
    public void whenFoolStudentClassB() {
        List<Student> students = List.of(
    ...
    @Test
    public void whenVeryFoolStudentClassC() {
        List<Student> students = List.of(
                new Student(10, "Surname1"),
                new Student(30, "Surname3"),
                new Student(40, "Surname4"),
