...
public class StudentLevelTest {
    ...
    public void whenSorted() {
        ...
        assertThat(StudentLevel.level(input, 20), is(expected));
    }
    ...
    public void whenOnlyNull() {
        ...
        input.add(null);
        List<Student> expected = List.of();
        assertThat(StudentLevel.level(input, 100), is(expected));
    }
    ...
    public void whenHasNull() {
        ...
        assertThat(StudentLevel.level(input, 10), is(expected));
    }
}